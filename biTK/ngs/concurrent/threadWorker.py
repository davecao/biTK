...
#    threadSleepTime = 0.5
    ...
    def __init__(self, tasks, dead_thread_queue, thread_event, wait_time, 
        ...
        #if wait_time < 0:
        #    self.get_task = {'get':self.tasks.get_nowait}
        #else:
        #    self.get_task = {'get':self.tasks.get}
        self.daemon = True
        self.start()
